...
\newglossaryentry{CI/CD} {name={CI/CD},description={{(Continuous Integration/Continuous Delivery) Integración Continua/Entrega Continua.
...
\begin{document}
    ...
    \input{./part/Proyecto_ejecutivo/Proyecto_ejecutivo}

    \newpage
    \section{Ejecución}\label{sec:ejecucion}
    \input{./part/Ejecucion/Ejecucion}

    \newpage
    \section{Conclusiones}\label{sec:conclusiones}
    \input{./part/Conclusiones}
