...
Si existiese un numero exacto de pruebas óptimas, para cubrir todas la posibilidades con tests, si haces menos estas siendo ineficaz y si haces más ineficiente.
